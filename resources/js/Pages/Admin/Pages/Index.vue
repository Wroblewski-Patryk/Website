        ...
        >
            ...
            <template #cell-actions="{ item }">
                <div class="flex justify-end gap-2 text-center">
                    <a :href="`/${t(item.slug)}`" target="_blank" class="btn btn-sm btn-ghost btn-square hover:bg-info/10 hover:text-info transition-all" :title="t('admin.common.preview', 'Preview')">
